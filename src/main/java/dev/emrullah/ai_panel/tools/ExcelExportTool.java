...
"""
    ...
    public String generateBarChartExcelFromJpql(
...
"""
    ...
    public String generateTabularExcelWithJpql(
    ...
    private String buildBarChartExcel(
            String sheetName,
        ...
        try (XSSFWorkbook workbook = new XSSFWorkbook();
            ...
            XSSFClientAnchor anchor = drawing.createAnchor(
                    0, 0, 0, 0,
                    chartColStart, chartRowStart, chartColEnd, chartRowEnd
            );
